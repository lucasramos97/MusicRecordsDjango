...
class GetDeletedMusicsTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        MusicFactory.create_batch(10, deleted=True, user=create_user('2'))
        MusicFactory.create(user=cls.db_user1)

    def test_get_deleted_musics_with_default_query_params(self):
        ...
        db_musics = Music.objects.filter(deleted=True, user=self.db_user1)
    ...
    def test_get_deleted_musics_with_explicit_query_params(self):
    ...
    def test_get_deleted_musics_with_inappropriate_tokens(self, header, expected_message):
    ...
    def test_get_deleted_musics_without_authorization_header(self):
    ...
    def test_get_deleted_musics_without_bearer_authentication_scheme(self):
    ...
    def test_get_deleted_musics_with_expired_token(self):
